...
The goal is to build a simple platform where students can find and connect with others who share similar interests in a university environment.

##  Team

This is a group project for our flutter course.
